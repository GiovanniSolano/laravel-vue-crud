<template>
    ...
    <div class="container mt-5">
        ...
        <h1 class="mt-3">Add a simple product</h1>
        ...
        <form class="mt-3" autocomplete="off" @submit.prevent="createProduct">
    ...
    setup() {
        ...
        return {
            ...
            createProduct: async() => {
                ...
                const resp = await createProduct(productForm.value);
